# Generated by Django 3.2.12 on 2022-08-15 14:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('official_title', models.CharField(blank=True, max_length=256, null=True, verbose_name='Official Title')),
                ...
                ('creator', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='journal_creator', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='journal_last_mod_user', to=settings.AUTH_USER_MODEL, verbose_name='Updater')),
            ],
            options={
                'abstract': False,
            },
