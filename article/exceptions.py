...
class RenditionCreateOrUpdateError(Exception): ...


class UpdateArticleProcError(Exception): ...


class MigratedXMLCreateOrUpdateError(Exception): ...


class TranslationFileCreateOrUpdateError(Exception): ...
