...
> **Importante:** Esta tarea **solo** crea o actualiza registros `PidProviderXML`
> y `XMLURL`. **No** crea registros de `Article`.
...
| 🟡 | Los registros XMLURL muestran estado de error | Verifique el campo `exceptions` en `XMLURL` para obtener detalles. Las causas comunes incluyen URLs de XML inválidas o errores temporales del servidor. Los registros serán reintentados en ejecuciones futuras. |
