...
Os registros coletados do OPAC já possuem um identificador **PID v3** atribuído.
Por essa razão, a fonte de dados **deve** ser o site oficial do SciELO
(ex., `https://www.scielo.br`). Usar qualquer outra fonte pode resultar na
criação de identificadores PID v3 inéditos que não correspondem a artigos
publicados, comprometendo a integridade dos dados.
