...
@celery_app.task(bind=True, name="migrate_set_of_issue_files_and_document_records")
def task_migrate_set_of_issue_files_and_document_records(
    self,
    username,
    collection_acron,
    scielo_issn=None,
    ...
    for migrated_issue in items.iterator():
        task_migrate_one_issue_files_and_document_records.apply_async(
            kwargs={
                "username": username,
...
@celery_app.task(bind=True, name="migrate_one_issue_files_and_document_records")
def task_migrate_one_issue_files_and_document_records(
    self,
    username,
    migrated_issue_id,
    collection_acron,
