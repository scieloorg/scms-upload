...
VE_PACKAGE_ARTICLE_JOURNAL_INCOMPATIBILITY_ERROR = 'package-article-journal-incompatibility-error'
VE_PACKAGE_ARTICLE_IS_NOT_NEW_ERROR = 'package-article-is-not-new-error'
...
VALIDATION_ERROR_CATEGORY = (
    ...
    (VE_PACKAGE_ARTICLE_JOURNAL_INCOMPATIBILITY_ERROR, 'PACKAGE_ARTICLE_JOURNAL_INCOMPATIBILITY_ERROR'),
    (VE_PACKAGE_ARTICLE_IS_NOT_NEW_ERROR, 'PACKAGE_ARTICLE_IS_NOT_NEW_ERROR'),
