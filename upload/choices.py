...
# Model Package, Field type
PT_ERRATUM = 'erratum'
PT_CORRECTION = 'correction'
PT_NEW_DOCUMENT = 'new-document'
PT_SYSTEM_GENERATED = 'generated-by-the-system'

PACKAGE_TYPE = (
    (PT_CORRECTION, _('Correction')),
    (PT_ERRATUM, _('Erratum')),
    (PT_NEW_DOCUMENT, _('New document')),
    (PT_SYSTEM_GENERATED, _('Generated by the system')),
)
