...
from .models import PidRequest, PidRequesterXML, PidChange, PidProviderConfig
...
class PidRequesterAdminGroup(ModelAdminGroup):
    ...
    items = (PidProviderConfigAdmin, PidRequesterXMLAdmin, PidRequestAdmin, PidChangeAdmin)
